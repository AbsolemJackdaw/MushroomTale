...
public class Player extends MapObject {
	...
	private final double doubleJumpStart;
	...
	private final Rectangle ar;
	private final Rectangle aur;
	private final Rectangle cr;
	...
	public void draw(Graphics2D g) {
		...
		// draw emote
		if (emote == CONFUSED)
			g.drawImage(confused, (int) ((x + xmap) - (cwidth / 2)),
					(int) ((y + ymap) - 40), null);
		else if (emote == SURPRISED)
			g.drawImage(surprised, (int) ((x + xmap) - (cwidth / 2)),
					(int) ((y + ymap) - 40), null);
	...
	public String getTimeToString() {
		final int minutes = (int) (time / 3600);
		final int seconds = (int) ((time % 3600) / 60);
	...
	public void update() {
		...
		// update position
		final boolean isFalling = falling;
		getNextPosition();
